...
def makeFile(nbrhood):
    ...
    titleString = "id=\"Neighborhood Title\">Common Core - Khan's Tutorial</title>"
    bannerString = "id=\"Neighborhood 1\">Common Core Tutoring</h1>"
    featureString = "Why do families choose Khan's"
    newTString = titleString.replace("Common Core - Khan's Tutorial</title>",nbrhood.replace('-',' ')+" Common Core - Khan's Tutorial</title>")
    newBString = bannerString.replace("Common Core Tutoring</h1>",nbrhood.replace('-',' ')+" Common Core Tutoring</h1>")
